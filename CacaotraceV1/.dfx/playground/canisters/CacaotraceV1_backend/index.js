...
import { idlFactory } from './CacaotraceV1_backend.did.js';
export { idlFactory } from './CacaotraceV1_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CACAOTRACEV1_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./CacaotraceV1_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the CacaotraceV1_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./CacaotraceV1_backend.did.js")._SERVICE>}
 */
export const CacaotraceV1_backend = createActor(canisterId);
