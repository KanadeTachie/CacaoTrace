...
import { idlFactory } from './CacaotraceV1_frontend.did.js';
export { idlFactory } from './CacaotraceV1_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CACAOTRACEV1_FRONTEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./CacaotraceV1_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the CacaotraceV1_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./CacaotraceV1_frontend.did.js")._SERVICE>}
 */
export const CacaotraceV1_frontend = createActor(canisterId);
